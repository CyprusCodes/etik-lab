  ...
  return (
    <Layout>
      <SEO
        ...
        description="Diyabet paneli kapsamında değerlendirilen testler ve laboratuvar süreci hakkında bilgi alın."
        path="/test-panelleri/diyabet"
      />
      <BreadcrumbSchema
        items={[
          { name: "Ana Sayfa", path: "/" },
          { name: "Test Panelleri", path: "/test-panelleri" },
          { name: "Diyabet Paneli", path: "/test-panelleri/diyabet" },
        ]}
      />
      {/* Hero Section */}
