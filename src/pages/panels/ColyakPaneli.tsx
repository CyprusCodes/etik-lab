...
export default function ColyakPaneli() {
  ...
  return (
    <Layout>
      <SEO
        title="Çölyak Paneli"
        description="Çölyak paneli kapsamında değerlendirilen testler ve laboratuvar süreci hakkında bilgi alın."
        path="/test-panelleri/colyak"
      />
      <BreadcrumbSchema
        items={[
          { name: "Ana Sayfa", path: "/" },
          { name: "Test Panelleri", path: "/test-panelleri" },
          { name: "Çölyak Paneli", path: "/test-panelleri/colyak" },
        ]}
      />
      {/* Hero Section */}
