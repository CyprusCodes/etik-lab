        ...
        <div className="container-narrow">
          <div className="bg-card rounded-2xl p-8 border border-border">
            <div className="grid md:grid-cols-3 gap-6 mb-8 pb-8 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground text-sm">Uygun günü belirleyin</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary-light flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground text-sm">08:00 - 18:00 arası</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary-light flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground text-sm">Şube veya evde hizmet</div>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Tercih Edilen Tarih *</label>
                  <Input type="date" required />
                </div>
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Tercih Edilen Saat</label>
                  <Select>
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-2">Adres (Evde hizmet için)</label>
                <Textarea placeholder="Evde numune alma hizmeti için adresinizi yazın..." rows={3} />
              </div>

              <div>
                <label className="block text-sm font-medium text-foreground mb-2">Belge Yükleme</label>
                <div className="border-2 border-dashed border-border rounded-xl p-8 text-center hover:border-primary/50 transition-colors cursor-pointer">
                  <Upload className="w-8 h-8 text-muted-foreground mx-auto mb-2" />
                  <p className="text-muted-foreground text-sm">Reçete veya istem belgelerinizi yükleyin</p>
                  <p className="text-muted-foreground text-xs mt-1">PDF, JPG, PNG (Maks. 10MB)</p>
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-foreground mb-2">Notlar</label>
                <Textarea placeholder="Eklemek istediğiniz notlar..." rows={3} />
              </div>

              <Button type="submit" size="lg" className="w-full">Randevu Oluştur</Button>
            </form>
          </div>
        </div>
      </section>
