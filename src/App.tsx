    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/hizmetlerimiz/ayaktan-hasta" element={<OutpatientServices />} />
          <Route path="/hizmetlerimiz/evde-numune" element={<HomeSampleCollection />} />
          <Route path="/hizmetlerimiz/genetik-testler" element={<GeneticTests />} />
          <Route path="/hizmetlerimiz/sma-testi" element={<SMATest />} />
          <Route path="/hizmetlerimiz/kurumsal" element={<CorporateServices />} />
          <Route path="/hizmetlerimiz/covid" element={<CovidTests />} />
          
          {/* Test Panels */}
          <Route path="/test-panelleri" element={<TestPanels />} />
          <Route path="/test-panelleri/cinsel-hastaliklar" element={<STDPanel />} />
          ...
          <Route path="/test-panelleri/kolon-kanseri" element={<ColonCancerPanel />} />
          <Route path="/test-panelleri/romatoloji" element={<RheumatologyPanel />} />
